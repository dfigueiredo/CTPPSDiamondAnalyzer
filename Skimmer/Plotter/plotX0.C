...
void plotX0(){
  ...
  while ((key = (TKey*)next())) {
    ...
    if(name.find("x0, plane0, ") != string::npos){
      tsector_45->cd(1);
      leg_pl0->AddEntry(histo,name.c_str(), "LF");
      histo->GetXaxis()->SetTitle("x [mm]");
      histo->GetYaxis()->SetTitle("Entries");
      histo->Draw("SAME");
    }

    if(name.find("x0, plane1, ") != string::npos){
      tsector_45->cd(2);
      leg_pl1->AddEntry(histo,name.c_str(), "LF");
      histo->GetXaxis()->SetTitle("x [mm]");
      histo->GetYaxis()->SetTitle("Entries");
      histo->Draw("histosame");
    }

    if(name.find("x0, plane2, ") != string::npos){
      tsector_45->cd(3);
      leg_pl2->AddEntry(histo,name.c_str(), "LF");
      histo->GetXaxis()->SetTitle("x [mm]");
      histo->GetYaxis()->SetTitle("Entries");
      histo->Draw("histosame");
    }

    if(name.find("x0, plane3, ") != string::npos){
      tsector_45->cd(4);
      leg_pl3->AddEntry(histo,name.c_str(), "LF");
      histo->GetXaxis()->SetTitle("x [mm]");
      histo->GetYaxis()->SetTitle("Entries");
      histo->Draw("histosame");
    }

    if(name.find("x0, plane10, ") != string::npos){
      tsector_56->cd(1);
      leg_pl10->AddEntry(histo,name.c_str(), "LF");
      histo->GetXaxis()->SetTitle("x [mm]");
      histo->GetYaxis()->SetTitle("Entries");
      histo->Draw("histosame");
    }
    if(name.find("x0, plane11, ") != string::npos){
      tsector_56->cd(2);
      leg_pl11->AddEntry(histo,name.c_str(), "LF");
      histo->GetXaxis()->SetTitle("x [mm]");
      histo->GetYaxis()->SetTitle("Entries");
      histo->Draw("histosame");
    }

    if(name.find("x0, plane12, ") != string::npos){
      tsector_56->cd(3);
      leg_pl12->AddEntry(histo,name.c_str(), "LF");
      histo->GetXaxis()->SetTitle("x [mm]");
      histo->GetYaxis()->SetTitle("Entries");
      histo->Draw("histosame");
    }

    if(name.find("x0, plane13, ") != string::npos){
      tsector_56->cd(4);
      leg_pl13->AddEntry(histo,name.c_str(), "LF");
      histo->GetXaxis()->SetTitle("x [mm]");
      histo->GetYaxis()->SetTitle("Entries");
      histo->Draw("histosame");
    }
