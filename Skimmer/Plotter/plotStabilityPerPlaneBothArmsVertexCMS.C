...
void plotStabilityPerPlaneBothArmsVertexCMS(){
  ...
  h_vertexz->SetMarkerColor(kBlack);
  ...
  for(int ch_id=0; ch_id<12; ch_id++){
    ...
    xmin0 = 0;
    xmax0 = h0_arm0->GetXaxis()->GetBinCenter(h0_arm0->FindLastBinAbove(1))+10;
    ...
    xmin1 = 0;
    xmax1 = h1_arm0->GetXaxis()->GetBinCenter(h1_arm0->FindLastBinAbove(1))+10;
    ...
    xmin2 = 0;
    xmax2 = h2_arm0->GetXaxis()->GetBinCenter(h2_arm0->FindLastBinAbove(1))+10;
    ...
    xmin3 = 0;
    xmax3 = h3_arm0->GetXaxis()->GetBinCenter(h3_arm0->FindLastBinAbove(1))+10;

    h_vertexz->GetXaxis()->SetRangeUser(xmin0,xmax0);
    ...
    Double_t xmin = 0;
    Double_t xmax = h0_arm0->GetXaxis()->GetBinCenter(h0_arm0->FindLastBinAbove(1))+10;
