...
void plotLeadingEdgeVsVertexZPerPlane(){
  ...
  for(int ch_id=0; ch_id<12; ch_id++){
    ...
    TLegend* leg = new TLegend(0.75,0.15,0.88,0.28);

    std::string histoname_arm0_pl0 = Form("meanGetLeadingVsVertexZArm0Pl0Ch%i", ch_id);
    std::string histoname_arm0_pl1 = Form("meanGetLeadingVsVertexZArm0Pl1Ch%i", ch_id);
    std::string histoname_arm0_pl2 = Form("meanGetLeadingVsVertexZArm0Pl2Ch%i", ch_id);
    std::string histoname_arm0_pl3 = Form("meanGetLeadingVsVertexZArm0Pl3Ch%i", ch_id);

    std::string histoname_arm1_pl0 = Form("meanGetLeadingVsVertexZArm1Pl0Ch%i", ch_id);
    std::string histoname_arm1_pl1 = Form("meanGetLeadingVsVertexZArm1Pl1Ch%i", ch_id);
    std::string histoname_arm1_pl2 = Form("meanGetLeadingVsVertexZArm1Pl2Ch%i", ch_id);
    std::string histoname_arm1_pl3 = Form("meanGetLeadingVsVertexZArm1Pl3Ch%i", ch_id);
    ...
    ymax0 = h0_arm1->GetMaximum()+0.3*h0_arm1->GetMaximum();
    ymin0 = h0_arm1->GetMaximum()-0.3*h0_arm1->GetMaximum();
    ...
    ymax1 = h1_arm0->GetMaximum()+0.3*h1_arm0->GetMaximum();
    ymin1 = h1_arm0->GetMaximum()-0.3*h1_arm0->GetMaximum();
    ...
    ymax2 = h2_arm0->GetMaximum()+0.3*h2_arm0->GetMaximum();
    ymin2 = h2_arm0->GetMaximum()-0.3*h2_arm0->GetMaximum();
    ...
    ymax3 = h3_arm0->GetMaximum()+0.3*h3_arm0->GetMaximum();
    ymin3 = h3_arm0->GetMaximum()-0.3*h3_arm0->GetMaximum();
    ...
    std::string pngname = Form("meanGetLeadingVsVertexZ_PerPlanesBothArmsCh%i.png", ch_id);
